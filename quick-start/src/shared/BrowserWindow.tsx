...
// inline: when true, skip the AbsoluteFill wrapper — use in split-screen layouts.
...
}> = ({ url = "localhost:8080/admin", scaleUp = true, width = 1680, height = 950, inline = false, children }) => {
